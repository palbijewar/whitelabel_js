...
const superAdminMenu = [
  ...
  },
  {
    ...
    name: "Signals",
    icon: "wifi_tethering",
    linkParent: "/app/admin/signals",
  },
  {
    key: "subscriptions",
    name: "Subscriptions",
    icon: "subscriptions",
    linkParent: "/app/admin/subscriptions",
  },
  {
    key: "employees",
    name: "Employees",
    icon: "badge",
    linkParent: "/app/admin/employees",
  },
  {
    key: "package",
    name: "Package",
    icon: "inventory",
    linkParent: "/app/admin/package",
  },
  {
    key: "terminal",
    name: "Terminal",
    icon: "computer",
    linkParent: "/app/admin/terminal",
  },
  {
    key: "settings",
    name: "Settings",
    icon: "settings",
    linkParent: "/app/admin/settings",
  },
  {
    key: "notification",
    name: "Notification",
    icon: "notifications",
    linkParent: "/app/admin/notifications",
  },
];
